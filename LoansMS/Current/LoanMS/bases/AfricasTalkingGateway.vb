...
Public Class AfricasTalkingGateway
    ...
    Private Shared ReadOnly SMS_URLString As String = "https://api.africastalking.com/version1/messaging"
    Private Shared ReadOnly VOICE_URLString As String = "https://voice.africastalking.com"
    Private Shared ReadOnly USERDATA_URLString As String = "https://api.africastalking.com/version1/user"
    Private Shared ReadOnly SUBSCRIPTION_URLString As String = "https://api.africastalking.com/version1/subscription"
    Private Shared ReadOnly AIRTIME_URLString As String = "https://api.africastalking.com/version1/airtime"

    ' Change this flag to true to view full server response
    Private Shared ReadOnly DEBUG As Boolean = False
    ...
    Public Function FetchMessages(lastReceivedId_ As Integer) As Object()
        ...
        If responseCode = HttpStatusCode.OK Then
            ...
            Dim smsMessageData As Object = json("SMSMessageData")
            Dim data2 As Object()
            data2 = TryCast(smsMessageData("Messages"), Object())
