        ...
        <div class="panel panel-primary">
            ...
            <div class="panel-body">
                ...
                <div class="col-md-4 form-horizontal">
                    ...
                    <div class="row form-group">
                        <%--<label id="lbRecordNo" class="control-label col-md-4" style="padding-top:0.5%;" for="txtRecordNo" runat="server">Record No:</label>--%>
                        <div class="col-md-4">
                    ...
                    <div class="row form-group">
                        <%--<label id="lbCustomerGroup" class="control-label col-md-4" style="padding-top:0.5%;" for="txtCustomerGroup" runat="server">Customer Group:</label>--%>
                        <div class="col-md-8">
                    ...
                    <div class="row form-group">
                        <%--<label id="lbDate" class="col-md-4 control-label" style="padding-top:0.5%;" for="txtMessage" runat="server">Message:</label>--%>
                        <div class="col-md-12">
                    ...
                    <div class="row form-group">
                        <%--<label id="lbDept" class="col-md-4 control-label" style="padding-top:0.5%;" for="lsDept" runat="server">Customer Type:</label>--%>
                        <div class="col-md-8">
                    ...
                    <div class="row form-group">
                        <%--<label id="lbStatusMsgs" class="col-md-4 control-label" style="padding-top:0.5%;" for="slStatusMsgs" runat="server">Message:</label>--%>
                        <div class="col-md-6">
